...
TARGET_HEIGHT     = 720                      
NUM_OCR_WORKERS   = 4                        
QUEUE_MAXSIZE     = 32                       # 32 * (720x1280*3bytes) = 86MB of RAM 
KNOWN_MAPS = [
...
def stream_frames(video_path, interval_s, width, height, hw_accel, frame_queue):
    """
...
def main():
    ...
    stream_frames(VIDEO_PATH, INTERVAL_SECONDS, width, height, HW_ACCEL, frame_queue)
    t1 = time.time()
